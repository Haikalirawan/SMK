...
<div class="bs-example">
    ...
    <form class="form-horizontal" action="proses_tambah_asalSek.php" method="POST">
        <div class="form-group">
            <label class="control-label col-xs-2" for="sekolah">Nama sekolah: </label>
            <div class="col-xs-8">
                <input type="text" required autocomplete="off" name="sekolah" class="form-control" id="sekolah" placeholder="Nama sekolah anda" autofocus>
            </div>
        </div>
        <br>
        <div class="form-group">
