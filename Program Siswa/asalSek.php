...
$result = mysqli_query($conn, "SELECT kode,asal_sekolah FROM tbl_sekolah ");

// Pencarian (query setelah search)
if (isset($_POST["search"])) {
  $keyword = $_POST['keyword'];
  $result = mysqli_query($conn, "SELECT kode,asal_sekolah FROM tbl_sekolah WHERE asal_sekolah LIKE '%$keyword%' ORDER BY asal_sekolah ASC");
}
...
<nav class="navbar navbar-inverse navbar-fixed-top">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav navbar-left">
      ...
      <li class="active"><a href="asalSek.php">Asal sekolah</a></li>
...
<br>
<br>
          <a href="daftar_asalSek.php" class="tambah_data"><i class="fa fa-graduation-cap fa-lg" style="color: white">&nbsp;&nbsp;</i>Tambah sekolah</a>
          ...
          <table class="table table-bordered table-striped table-hover">
              ...
              <?php foreach ($row as $key): ?>
                ...
                <td class="text-center">
                  <a href="update_asalsek.php?id=<?php echo $key['kode'] ?>"><i class="fa fa-edit fa-2x" style="color: #51cf66;"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;
                  <a href="delete_asalsek.php?id=<?php echo $key['kode'] ?>" onclick="return confirm('apakah anda yakin ingin menghapus??')"><i class="fa fa-trash fa-2x" style="color: #ff6b6b;"></i></a>
                </td>
              </tr>
              <?php $j++ ?>
              <?php endforeach ?>
