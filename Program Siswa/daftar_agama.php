...
<div class="bs-example">
    <h2>Daftar agama baru</h2>
    <form class="form-horizontal" action="proses_tambah_agama.php" method="POST">
        <div class="form-group">
            <label class="control-label col-xs-2" for="agama">Agama: </label>
            <div class="col-xs-8">
                <input type="text" required autocomplete="off" name="agama" class="form-control" id="agama" placeholder="Nama agama baru" autofocus>
            </div>
        </div>
        <br>
        <div class="form-group">
