...
$result = mysqli_query($conn, "SELECT kode,agama FROM tbl_agama ");

// Pencarian (query setelah search)
if (isset($_POST["search"])) {
  $keyword = $_POST['keyword'];
  $result = mysqli_query($conn, "SELECT kode,agama FROM tbl_agama WHERE agama LIKE '%$keyword%' ORDER BY agama ASC");
}
...
<br>
<br>
          <a href="daftar_agama.php" class="tambah_data"><i class="fa fa-plus fa-lg" style="color: white">&nbsp;&nbsp;</i>Tambah agama</a>
          ...
          <table class="table table-bordered table-striped table-hover">
              ...
              <?php foreach ($row as $key): ?>
                ...
                <td class="text-center">
                  <a href="update_agama.php?id=<?php echo $key['kode'] ?>"><i class="fa fa-edit fa-2x" style="color: #51cf66;"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;
                  <a href="delete_agama.php?id=<?php echo $key['kode'] ?>" onclick="return confirm('apakah anda yakin ingin menghapus??')"><i class="fa fa-trash fa-2x" style="color: #ff6b6b;"></i></a>
                </td>
              </tr>
              <?php $j++ ?>
              <?php endforeach ?>
